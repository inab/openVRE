			...
			<div class="page-content">
										...
										<div class="form-group formatTR" id="formatTR<?php echo $idx; ?>">
											...
											<select id="format<?php echo $idx; ?>" name="format" onchange="customfromFormat(this.value, <?php echo $idx; ?>)" class="form-control formatSelector file-type-selector">
												...
												<?php foreach ($filetypes as $ft) { ?>
													<option value="<?php echo $ft['_id']; ?>" <?php if (in_array($fileExtension, $ft['extension'])) {
																									echo "selected";
																								} ?>><?php echo $ft['_id']; ?></option>
												<?php } ?>

												<!--<option value="" >Select the file format</option>
						 <option value="BAM"  <?php if ($fileExtension == "BAM") {
													echo "selected";
												} ?> >BAM</option>
						 <option value="BED"  <?php if ($fileExtension == "BED") {
													echo "selected";
												} ?> >BED </option>
						 <option value="BEDGRAPH"<?php if ($fileExtension == "BEDGRAPH") {
														echo "selected";
													} ?>>BEDGRAPH</option>
						 <option value="WIG"  <?php if ($fileExtension == "WIG") {
													echo "selected";
												} ?> >WIG</option>
						 <option value="BW"   <?php if ($fileExtension == "BW") {
													echo "selected";
												} ?> >BIGWIG</option>
						 <option value="GFF"  <?php if (in_array($fileExtension, array("GTF", "GFF"))) {
													echo "selected";
												} ?> >GFF/GTF</option>
						 <option value="GFF3" <?php if ($fileExtension == "GFF3") {
													echo "selected";
												} ?> >GFF3</option>
						 <option value="FASTQ"<?php if (in_array($fileExtension, array("FASTQ", "FQ"))) {
													echo "selected";
												} ?>>FASTQ</option>
						 <option value="FASTA"<?php if (in_array($fileExtension, array("FA", "FASTA", "FN"))) {
													echo "selected";
												} ?>>FASTA</option>
						 <option value="PDB"  <?php if ($fileExtension == "PDB") {
													echo "selected";
												} ?> >PDB</option>
						 <option value="TXT"  <?php if ($fileExtension == "TXT") {
													echo "selected";
												} ?> >TXT</option>
						 <option value="DCD"  <?php if ($fileExtension == "DCD") {
													echo "selected";
												} ?> >DCD</option>
						 <option value="GRO"  <?php if ($fileExtension == "GRO") {
													echo "selected";
												} ?> >GRO</option>
							<option value="GEM"  <?php if ($fileExtension == "GEM") {
														echo "selected";
													} ?> >GEM</option>
							<option value="PARMTOP"  <?php if (in_array($fileExtension, array("PARMTOP", "PRMTOP", "TOP"))) {
															echo "selected";
														} ?> >PARMTOP</option>
						<option value="MDCRD"  <?php if (in_array($fileExtension, array("MDCRD", "TRJ"))) {
													echo "selected";
												} ?> >MDCRD</option>
			    ...
			    <?php
       				...
       				<?php
				        ...
				        <input type="submit" id="submit"  value="Validate" onclick="javascript:document.getElementById('op').value='checkParams'" <?php if (isset($_REQUEST['compressed'][$IDX]) && $_REQUEST['compressed'][$IDX]) {
																																						echo "class=\"disabled\"";
																																					} ?> />
				...
				<input type="submit" class="btn green" id="submit" value="Validate first time" onclick="javascript:document.getElementById('op').value='checkParams'" <?php if ($_REQUEST['compressed'][$IDX]) {
																																											echo "class=\"disabled\"";
																																										} ?> />
