$(document).ready(function() {
    ...
    $('#add').on("click", function() {
        ...
        DT = $('#gwasTable').DataTable( {
            ...
            "columnDefs": [
                ...
                //{ "title": "", "orderable": false, "className": 'select-checkbox', "targets": 0 },
                //{ 'targets': 0, 'checkboxes': { 'selectRow': true } },
                //<th class="toggle-all"><i id="select_all" name=""></i></th>
    ...
    /*
    $('#gwasTable').on('click', 'tr', function () {
        $('#dt-button').html('<button> Send to workspace </button>');
    });*/

    /*
    $('#dt-submit').on('submit', function(e){
        e.preventDefault();
        var form = this;
