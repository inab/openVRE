  ...
  height: 300px; /* Should be removed. Only for demonstration */
		...
		<div>
		   <div style="float:left; margin-top:28px;">
			<h1 class="page-title"> euro-BioImaging
                    	<small>&nbsp; The European Research Infrastructure for Imaging Technologies in Biological and Biomedical Sciences</small>
                	</h1>
		   </div>
		   <div style="float:right;">
			<a href="https://www.eurobioimaging.eu/" target="_blank"><img src="https://academicpositions.es/uploads/42b/f07/42bf07f40ba63b4d0a53ac64cf9e470b.png" width="300px;"/></a>
		   </div>
		</div>
