        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <h1 class="page-title"> EuroBioImaging
                    <small> List of experiments for an specific project and subject </small>
                </h1>
                <!-- END PAGE TITLE -->
                <!-- END PAGE HEADER -->
                          ...
                          <div id="loading-datatable" class="loadingForm" style="display:none;">
                            ...
                            <div class="portlet light portlet-fit bordered" id="general">
                                <div id="workflows" class="portlet-body">
                                    ...
                                    <table id="experimentsTableAuth" class="table table-striped table-hover table-bordered"></table>
                                </div>
                            </div>
