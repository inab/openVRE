		...
		<!-- BEGIN PORTLET 1: PROJECT -->
		 ...
		 <div class="portlet box blue form-block-header" id="form-block-header1">
			 ...
			 <div class="form-body">
			     ...
			     <div class="row">
				<div class="col-md-6">
                                     <?php $ff = matchFormat_File($tool['input_files']['images']['file_type'], $inPaths); ?>
				     <?php InputTool_printSelectFile($tool['input_files']['images'], $rerunParams['images'], $ff, true, true); ?>
                                 </div>
                                 <div class="col-md-6">
                                      <?php $ff = matchFormat_File($tool['input_files_public_dir']['model']['file_type'], $inPaths); ?>
                                       <?php InputTool_printListOfFiles($tool['input_files_public_dir']['model'], $rerunParams['model'], $ff[0], false, true); ?>
                                  </div>
			     </div>
