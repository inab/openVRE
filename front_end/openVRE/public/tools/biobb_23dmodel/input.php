...
$sites1= [[
        '_id' => 'local',
        'name' => 'Docker Local implementation',
        'status' => '1', // This site is selected by default
    ],
    [
        '_id' => 'azure',
        'name' => 'Azure Container implementation',
        'status' => '0', // This site is disabled by default
    ],
    [
        '_id' => 'marenostrum',
        'name' => 'HPC MareNostrum implementation',
   	'status' => '1',]];
$methods1 = ['Module for HPC', 'CLI', 'BioContainer', 'Workflow', 'Singularity Container'];
		...
		<!-- BEGIN PORTLET 1: PROJECT -->
		 ...
		 <div class="portlet box blue form-block-header" id="form-block-header1">
			 ...
			 <div class="form-body">
			   ...
			   <h4 class="form-section" style="font-weight:500;" >Tool Name: 3D Modelling</h4>
			   <div class="row">
			       <div class="col-md-6">
				    <ul>
				    <li>Container Image:&nbsp;&nbsp; <?php echo $tool['infrastructure']['container_image']; ?></li>
				    <li>Connectivity via:&nbsp;&nbsp;&nbsp; SSH</li>
				    <li>Launcher:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Docker Compose</li>
...
--->
			<div class="col-md-6">
				...
				<?php if( $_REQUEST["op"] == 0 ) {  ?>
					<div class="col-md-12">
						<?php $ff = matchFormat_File($tool['input_files']['horizontal_vertebral_disc_coords']['file_type'], $inPaths); ?>
						<?php InputTool_printSelectFile($tool['input_files']['horizontal_vertebral_disc_coords'], $rerunParams['horizontal_vertebral_disc_coords'], $ff[0], false, true); ?>
					</div>
				<?php } else { ?>
					<div class="col-md-6">
						<?php $ff = matchFormat_File($tool['input_files']['horizontal_vertebral_disc_coords']['file_type'], $inPaths); ?>
					...
					<div class="col-md-6">
						<?php $ff = matchFormat_File($tool['input_files']['vertical_vertebral_disc_coords']['file_type'], $inPaths); ?> 
						<?php InputTool_printSelectFile($tool['input_files']['vertical_vertebral_disc_coords'], $rerunParams['vertical_vertebral_disc_coords'], $ff[0], false, true); ?>
					</div>
				<?php } ?>				

			     </div>
				
				<input type="hidden" name= "input_files_public_dir[yaml_config]" value="<?php echo $tool['input_files_public_dir']['yaml_config']['value']; ?>" />
