		...
		<!-- BEGIN PORTLET 1: PROJECT -->
		 ...
		 <div class="portlet box blue form-block-header" id="form-block-header1">
			 ...
			 <div class="form-body">
			     ...
			     <div class="row">
				<div class="col-md-6">
                                     <?php $ff = matchFormat_File($tool['input_files']['subjects_id']['file_type'], $inPaths); ?>
				     <?php InputTool_printSelectFile($tool['input_files']['subjects_id'], $rerunParams['subjects_id'], $ff, false, true); ?>
                                 </div>
                                 <div class="col-md-6">
                                     <?php $ff = matchFormat_File($tool['input_files']['SNP_rs_number']['file_type'], $inPaths); ?>
				     <?php InputTool_printSelectFile($tool['input_files']['SNP_rs_number'], $rerunParams['SNP_rs_number'], $ff, false, false); ?>
                                  </div>
			     </div>
			     <div class="row">
				<div class="col-md-6">
                                     <?php $ff = matchFormat_File($tool['input_files']['bed_file']['file_type'], $inPaths); ?>
				     <?php InputTool_printSelectFile($tool['input_files']['bed_file'], $rerunParams['bed_file'], $ff, false, true); ?>
                                 </div>
                                 <div class="col-md-6">
                                     <?php $ff = matchFormat_File($tool['input_files']['fam_file']['file_type'], $inPaths); ?>
				     <?php InputTool_printSelectFile($tool['input_files']['fam_file'], $rerunParams['fam_file'], $ff, false, true); ?>
                                  </div>
			     </div>
			     <div class="row">
				<div class="col-md-6">
                                     <?php $ff = matchFormat_File($tool['input_files']['bim_file']['file_type'], $inPaths); ?>
				     <?php InputTool_printSelectFile($tool['input_files']['bim_file'], $rerunParams['bim_file'], $ff, false, true); ?>
                                 </div>
