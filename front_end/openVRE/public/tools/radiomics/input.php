		...
		<!-- BEGIN PORTLET 1: PROJECT -->
		 ...
		 <div class="portlet box blue form-block-header" id="form-block-header1">
			 ...
			 <div class="form-body">
			     ...
			     <div class="row">
				<div class="col-md-6">
                                     <?php $ff = matchFormat_File($tool['input_files']['images'], $inPaths); ?>
				     <?php InputTool_printSelectFile($tool['input_files']['images'], $rerunParams['images'], $ff, true, true); ?>
                                 </div>
                                 <div class="col-md-6">
                                     <?php $ff = matchFormat_File($tool['input_files']['masks'], $inPaths); ?>
				     <?php InputTool_printSelectFile($tool['input_files']['masks'], $rerunParams['masks'], $ff, true, true); ?>
                                  </div>
			     </div>
			     <div class="row">
				<div class="col-md-6">
                                     <?php $ff = matchFormat_File($tool['input_files']['metadata_file'], $inPaths); ?>
				     <?php InputTool_printSelectFile($tool['input_files']['metadata_file'], $rerunParams['metadata_file'], $ff, true, false); ?>
                                 </div>
                                 <div class="col-md-6">
                                  </div>
			     </div>
