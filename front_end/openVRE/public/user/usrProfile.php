                        ...
                        <div class="profile-sidebar">
                            ...
                            <div class="portlet light profile-sidebar-portlet ">
                                ...
                                <div class="profile-userpic">
                                    <img alt="" class="img-responsive<?php echo $dispClassAv1; ?>"
                                        src="<?php echo $avatarImg; ?>" />
                                    <div class="img-circle<?php echo $dispClassAv2; ?>" id="avatar-usr-profile"
                                        style="background-color:<?php echo $avatarColors[$bgColorAvatar]; ?>">
                                        <?php echo $firstLetterName . $firstLetterSurname; ?></div>
                                </div>
                                <!-- END SIDEBAR USERPIC -->
                                <!-- SIDEBAR USER TITLE -->
                        ...
                        <div class="profile-content">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane active" id="tab_1_1">
                                                    ...
                                                    <div class="alert alert-info display-hide" id="succ-chg-prf">
                                                        Your personal info has been updated. Use the left-hand menu to
                                                        start navigating!
                                                    </div>
                                                    <form role="form" action="javascript:;" id="form-change-profile">
                                                        ...
                                                        <?php if (!allowedRoles($_SESSION['User']['Type'], $GLOBALS['TOOLDEV']) && (checkTermsOfUse())) { ?>
                                                            <div class="form-group margin-top-30">
                                                                ...
                                                                <br /><br />
                                                                <a href="<?php echo $GLOBALS['BASEURL']; ?>helpdesk/?sel=tooldev"
                                                                    class="btn green">Become tool developer</a>
                                                            </div>
                                                        <?php } ?>
                                                        <div class="form-group margin-top-30">
                                                        ...
                                                        <div class="margin-top-10">
                                                            <?php if (isset($_SESSION['lastUserLogin'])) { ?>
                                                                <button type="submit" id="submit-changes"
                                                                    class="btn green">Save Changes</button>
                                                            <?php } else { ?>
                                                                <button type="submit" id="submit-changes"
                                                                    class="btn green">Save changes and go to
                                                                    Homepage</button>
                                                            <?php } ?>
                                                ...
                                                <div class="tab-pane" id="tab_1_2">
                                                    <p> Select an image from your computer. Max size: 1MB.
                                                        <?php if ($avatarExists == 1) { ?> If you want to remove your
                                                            profile picture, please click <i>Remove</i> button and then
                                                            <i>Submit</i>. <?php } ?>
                                                    </p>
                                                    ...
                                                    <form action="javascript:;" role="form" id="form-chg-img"
                                                        enctype="multipart/form-data">
                                                        <div class="form-group">
                                                            <div class="fileinput fileinput-<?php if ($avatarExists == 1)
                                                                echo 'exists';
                                                            else
                                                                echo 'new'; ?>"
                                                        ...
                                                        <div class="margin-top-10">
                                                            <a href="javascript:;" class="btn green" id="submit-img">
                                                                Submit </a>
                                                        </div>
                                                    </form>
                                                </div>
                                                ...
                                                <div class="tab-pane" id="tab_1_3">
                                                    ...
                                                    <form action="javascript:;" id="form-change-pwd">
                                                        ...
                                                        <div class="margin-top-10">
                                                            <button type="submit" id="submit-pwd"
                                                                class="btn green">Change Password</button>
                                                            <button type="reset" class="btn default">Reset Form</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                ...
                                                <div class="tab-pane" id="tab_1_4">
                                                    ...
                                                    <div class="form-group mt-clipboard-container">
                                                        ...
                                                        <div class="input-group">
                                                            <input id="mt-target-1" type="text" class="form-control"
                                                                value="<?php echo $_SESSION['User']['Token']['access_token']; ?>"
                                                    ...
                                                    <input id="exp-token" type="hidden"
                                                        value="<?php echo $_SESSION['User']['Token']['expires']; ?>">
                            ...
                            print ">>>>>>>>> EXP : $ed <br/>";*/
                                                    ...
                                                    <div class="form-group mt-clipboard-container">
                                                        ...
                                                        <div class="input-group">
                                                            <input id="mt-target-2" type="text" class="form-control"
                                                                value="<?php echo $_SESSION['User']['Token']['refresh_token']; ?>"
                                                                readonly style="background:#fff;">
                                                            <span class="input-group-btn">
                                                                <button class="btn green mt-clipboard"
                                                                    data-clipboard-action="copy"
                                                    ...
                                                    <input id="exp-refrtoken" type="hidden"
                                                        value="<?php echo $_SESSION['User']['Token']['expires'] + $_SESSION['User']['Token']['refresh_expires_in']; ?>">
                                                    <?php
