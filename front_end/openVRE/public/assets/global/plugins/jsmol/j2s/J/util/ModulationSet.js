...
this.xmod = this.gammaIinv.mul (this.sigma.mul (JU.Matrix.newT (r, true)).sub (this.sI));
...
}this.t = this.gammaIinv.mul (this.t).add (this.xmod);
...
modInfo.put ("xmod", this.xmod.getArray ());
