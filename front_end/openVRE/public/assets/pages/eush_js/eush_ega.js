$(document).ready(function() {
        ...
        for (var i = 0; i < ega_outbox.length; i++) {
            ...
            console.log(ega_outbox[i])
            ds_sites.push('applib/eush_ega.php?action=getEGADatasetsFromDSid&ds_id='+ega_outbox[i]+'')
        }
        ...
        $('#egaTable').DataTable( {
                ...
                dataSrc: function (jsonData) {
                    ...
                    for (var i = 0; i < ds_metadata.length; i++) {
                        ...
                        if(ds_metadata[i] != null) {
                            ...
                            datasetTitle = ds_metadata[i]["title"]
                            datasetTime = ds_metadata[i]["creationTime"]
                            datasetBeacon = ds_metadata[i]["availableInBeacon"]
                        } else {
                            console.log("yes")
            ...
            "columnDefs": [
                ...
                { "title": "Creation time", "targets": 2 },
                { "title": "Available in Beacon", "targets": 3 },
