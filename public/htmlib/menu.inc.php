...
switch(pathinfo($_SERVER['PHP_SELF'])['filename']){
	case 'index':
		...
		break;
	case 'input': 
	case 'output':       $currentSection = 'lt'; break;
	case 'newProject':   $currentSection = 'uw'; break;
	case 'editFile':     $currentSection = 'dt'; break;
	case 'uploadForm':	
	case 'uploadForm2':  $currentSection = 'dt'; $currentSubSection = 'lc'; break;
	case 'general':      $currentSection = 'he'; $currentSubSection = 'h1'; break;
	case 'starting':     $currentSection = 'he'; $currentSubSection = 'h2'; break;
	case 'upload':	     $currentSection = 'he'; $currentSubSection = 'h3'; break;	
	case 'ws':           $currentSection = 'he'; $currentSubSection = 'h4'; break;
	case 'launch':       $currentSection = 'he'; $currentSubSection = 'h5'; break;
	case 'tools':        $currentSection = 'he'; $currentSubSection = 'h6'; break;
	case 'visualizers':  $currentSection = 'he'; $currentSubSection = 'h11'; break;
	case 'hdesk':        $currentSection = 'he'; $currentSubSection = 'h7'; break;
	case 'related':      $currentSection = 'he'; $currentSubSection = 'h8'; break;
	case 'refs':         $currentSection = 'he'; $currentSubSection = 'h9'; break;
	case 'ackn':         $currentSection = 'he'; $currentSubSection = 'h10'; break;
	case 'repoExample': $currentSection = 'dt'; $currentSubSection = 'rp'; $currentSubSubSection = 'bs';  break;
	case 'dataFromTxt':  $currentSection = 'dt'; $currentSubSection = 'tx'; break;
	case 'dataFromID':   $currentSection = 'dt'; $currentSubSection = 'id'; break;
	case 'sampleDataList':$currentSection= 'dt'; $currentSubSection = 'sd'; break; 
	case 'usrProfile':   $currentSection = 'up'; $currentSubSection = 'mp'; break;
	case 'dashboard':    $currentSection = 'ad'; $currentSubSection = 'ds'; break;
	case 'adminUsers':   $currentSection = 'ad'; $currentSubSection = 'au'; break;
	case 'adminTools':   $currentSection = 'ad'; $currentSubSection = 'at'; $currentSubSubSection = 'mt'; break;
	case 'logs':         $currentSection = 'ad'; $currentSubSection = 'at'; $currentSubSubSection = 'lg'; break;
	case 'adminJobs':    $currentSection = 'ad'; $currentSubSection = 'aj'; break;
	case 'jsonTestValidator': 
	case 'jsonSpecValidator':
	case 'myNewTools': 
	case 'vmURL':
	case 'newTool': 
	case 'createTest':   $currentSection = 'ad'; $currentSubSection = 'at'; $currentSubSubSection = 'td'; break;
	case 'help':         $currentSection = 'he';
			     $a = explode("/", dirname($_SERVER['PHP_SELF']));
			     if($a[1] == "tools") { $currentSubSection = 'h6'; }else{ $currentSubSection = 'h11';}
			     $currentSubSubSection = $a[sizeof($a) - 2]; 
			     break;
	case 'method':       $currentSection = 'he'; $currentSubSection = 'h6';
			     $a = explode("/", dirname($_SERVER['PHP_SELF']));
			     $currentSubSubSection = $a[sizeof($a) - 2];
			     $currentSubSubSubSection = 'met';
			     break;
	case 'inputs':       $currentSection = 'he'; $currentSubSection = 'h6';
			     $a = explode("/", dirname($_SERVER['PHP_SELF']));
			     $currentSubSubSection = $a[sizeof($a) - 2];
			     $currentSubSubSubSection = 'inp';
			     break;
	case 'outputs':      $currentSection = 'he'; $currentSubSection = 'h6';
			     $a = explode("/", dirname($_SERVER['PHP_SELF']));
			     $currentSubSubSection = $a[sizeof($a) - 2];
			     $currentSubSubSubSection = 'out';
			     break;
	case 'results':      $currentSection = 'he'; $currentSubSection = 'h6';
			     $a = explode("/", dirname($_SERVER['PHP_SELF']));
			     $currentSubSubSection = $a[sizeof($a) - 2];
			     $currentSubSubSubSection = 'res';
			     break;
	case 'tutorials':    $currentSection = 'he'; $currentSubSection = 'h6';
			     $a = explode("/", dirname($_SERVER['PHP_SELF']));
			     $currentSubSubSection = $a[sizeof($a) - 2];
			     $currentSubSubSubSection = 'tut';
			     break;
	case 'references':   $currentSection = 'he'; $currentSubSection = 'h6';
			     $a = explode("/", dirname($_SERVER['PHP_SELF']));
			     $currentSubSubSection = $a[sizeof($a) - 2];
			    ...
			    <li class="nav-item  <?php if($currentSection == 'dt') { ?>active open<?php } ?>">
					...
					<ul class="sub-menu">
						<li class="nav-item <?php if($currentSubSubSection == 'bs') { ?>active open<?php } ?>">
						    <a href="repository/repoExample.php" class="nav-link">
