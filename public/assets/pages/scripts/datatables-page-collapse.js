...
$(document).ready(function() {
 ...
 /* $('.mock_button').click(function(){
  ...
  //$('.collapse-folder', table.rows().nodes()).on( 'click',null, $(this), collapseFolder);
  $('.collapse-folder', table.rows().nodes()).click(function() { collapseFolder(this); });

	
   // COLLAPSE FOLDERS with more than 5 files
  $.each( $('.collapse-folder', table.rows().nodes()), function(index,record){
   ...
   //$('.collapse-folder', table.rows().nodes()).each(function(index){console.log(this);});
  /* $('.collapse-folder', table.rows().nodes()).each(function(index){
	   collapseFolder();
	   console.log(this);
	   var tr = $(this).parent().parent();
	   var trID = tr.data("tt-id").toString();
	   //var l0 = $(this).data("tt-parent-id").toString();
	   //var id = $(this).data("tt-id").toString();
	   //var l1 = id.split(".");
	   console.log(trID);
  ...
  //folders.prevObject.each(function(index){console.log(this);});
