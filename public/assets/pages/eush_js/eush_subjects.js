$(document).ready(function() {
        ...
        var options = {
            ...
            "ajax": {
                url: 'applib/eush_eurobioimaging.php?action=getSubjects&project_id='+project_id+'',
            ...
            "columnDefs": [
                ...
                { render: function(data, type, row) {
                    ...
                    return '<a href="/vre/getdata/eush_bioimages/eush_experiments.php?project_id='+project_id+'&subject_id='+row.subjectID+'"> '+row.subjectID+' </a>'
                }, "targets": 0}
            ]
        }
        ...
        //GENERAL DATATABLE
        $('#subjectsTable').DataTable(options);
        });
