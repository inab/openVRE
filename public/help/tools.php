...
<!-- BEGIN CONTENT -->
                <div class="page-content-wrapper">
				  ...
				  <i class="fa fa-circle"></i>
                        ...
                        <!-- END PAGE BAR -->
                        <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Select a tool
                        </h1>
                        <!-- END PAGE TITLE-->
												<!-- END PAGE HEADER-->
                            ...
                            <div class="clearfix">
                                <div id="js-filters-lightbox-gallery2" class="cbp-l-filters-button cbp-l-filters-left">
                                    ...
                                    <a href="tools/<?php echo $t["_id"]; ?>/help/help.php" class="cbp-caption cbp-singlePageInline" data-title="<?php echo $t['title']; ?>" rel="nofollow">
